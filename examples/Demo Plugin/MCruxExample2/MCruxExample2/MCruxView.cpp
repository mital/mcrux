...
bool MCruxView::loadDefaultHTML() const
{
	...
	if (SUCCEEDED(hr))
	{
		...
		if (!defaultHTML)
		{
			//defaultHTML = SysAllocString(TEXT("<html><head><title>Mcrux Example: calling initialize method all the way to the registered Class.</title>\n <script type=\"text/javascript\">\n //<!-- \n \n var plugin_name = \"file_utils\"; \n mcrux.initialize(plugin_name); \n //-->\n </script></head><body><h1>hi!</h1></body></html>"));
			defaultHTML = SysAllocString(TEXT("<html><head><title>Mcrux Example: calling initialize method all the way to the registered Class.</title>\n <script type=\"text/javascript\">\n //<!-- \n \n alert(\"Hello World!\"); \n var plugin_name = \"demo\"; \n mcrux.initialize(plugin_name); \n demo.myFunction(); \n alert(\"Hello World! after initialize call\");  \n //-->\n </script></head><body><h1>hi!</h1></body></html>"));
		}
